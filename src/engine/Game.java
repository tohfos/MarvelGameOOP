...
public class Game  {
	...
	public void attack(Direction d)
		...
		if (c.getCurrentActionPoints() < 2)
			throw new NotEnoughResourcesException("YOU DO NOT HAVE ENOUGH ACTION POINTS"  );
		int i = 1;
		boolean found = false;
	...
	public static void switchFrames(GameFrame x , GameFrame y) {
		x.setVisible(false);
		y.setVisible(true);
	}
